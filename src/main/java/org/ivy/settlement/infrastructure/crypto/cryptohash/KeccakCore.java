...
abstract class KeccakCore extends DigestEngine {
	...
	protected long[] A;
	protected byte[] tmpOut;

	protected static final long[] RC = {
	 ...
	 */
	protected static void encodeLELong(long val, byte[] buf, int off)
	{
		buf[off + 0] = (byte)val;
	 ...
	 */
	protected static long decodeLELong(byte[] buf, int off)
	{
