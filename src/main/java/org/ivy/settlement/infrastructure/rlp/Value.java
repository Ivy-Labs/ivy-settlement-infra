...
public class Value {
    ...
    public boolean equals(Object o) {
        ...
        return decoded == value1.decoded &&
                Objects.equals(value, value1.value) &&
                Arrays.equals(rlp, value1.rlp) &&
                Arrays.equals(sha3, value1.sha3);
    }

    @Override
    public int hashCode() {

        int result = Objects.hash(value, decoded);
        result = 31 * result + Arrays.hashCode(rlp);
        result = 31 * result + Arrays.hashCode(sha3);
        return result;
    }
}
