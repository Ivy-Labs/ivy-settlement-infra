...
public class ByteUtil {
     ...
     * @param numBytes the desired blockSize of the resulting byte array
    ...
    /**
     * Omitting signECDSA indication byte.
     * <br><br>
    ...
    /**
     * Utility function to copy a byte array into a new byte array with given blockSize.
     * If the src length is smaller than the given blockSize, the result will be left-padded
     * with zeros.
     *
     * @param value - a BigInteger with a maximum value of 2^256-1
     * @return Byte array of given blockSize with a copy of the <code>src</code>
     */
    ...
    //public static int hexBytesToInt()
